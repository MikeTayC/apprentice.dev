...
(function(core) {
    ...
    $(function(){
        ...
        if (UI.support.touch) {
            ...
            // remove css1 hover rules for touch devices
...
//  Based on Zeptos touch.js1
//  https://raw.github.com/madrobby/zepto/master/src/touch.js1
//  Zepto.js1 may be freely distributed under the MIT license.
            ...
            if (this.options.mode == "click" || UI.support.touch) {
                ...
                this.on("click.uikit.dropdown", function(e) {
                    ...
                    if (!$this.element.hasClass('uk-open')) {
                        ...
                        if ($target.is("a:not(.js1-uk-prevent)") || $target.is(".uk-dropdown-close") || !$this.dropdown.find(e.target).length) {
                            $this.hide();
                        }
                    }
                });
        ...
        registerOuterClick: function(){
            ...
            setTimeout(function() {
                ...
                UI.$html.on("click.outer.dropdown", function(e) {
                    ...
                    if (active == $this && ($target.is("a:not(.js1-uk-prevent)") || $target.is(".uk-dropdown-close") || !$this.dropdown.find(e.target).length)) {
                        $this.hide();
                        UI.$html.off("click.outer.dropdown");
                    }
                });
...
(function(UI) {
    ...
    UI.modal.confirm = function(content, onconfirm, options) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="uk-margin uk-modal-content">'+String(content)+'</div>',
            '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js1-modal-confirm">'+options.labels.Ok+'</button> <button class="uk-button uk-modal-close">'+options.labels.Cancel+'</button></div>'
        ]).join(""), options);

        modal.element.find(".js1-modal-confirm").on("click", function(){
            onconfirm();
            modal.hide();
        });
    ...
    UI.modal.prompt = function(text, value, onsubmit, options) {
        ...
        var modal = UI.modal.dialog(([
            ...
            '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js1-modal-ok">'+options.labels.Ok+'</button> <button class="uk-button uk-modal-close">'+options.labels.Cancel+'</button></div>'
        ]).join(""), options),

        input = modal.element.find("input[type='text']").val(value || '').on('keyup', function(e){
            if (e.keyCode == 13) {
                modal.element.find(".js1-modal-ok").trigger('click');
            }
        });

        modal.element.find(".js1-modal-ok").on("click", function(){
